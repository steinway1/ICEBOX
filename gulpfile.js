...
gulp.task(
  'default', gulp.series(
    'clean:dev',
    gulp.parallel('twig:dev', 'css:dev', 'js:dev', 'js-promo:dev', 'js2:dev', 'js-plugins:dev', 'assets:dev', 'fonts:dev'),
...
gulp.task(
  'build', gulp.series(
    'clean:build',
    gulp.parallel('twig:build', 'css:build', 'js:build', 'js-promo:build', 'js2:build', 'js-plugins:build', 'js-vday:build', 'assets:build', 'fonts:build'),
