export default class Header {
  ...
  bindEvents() {
    this.loginBtn.on('mouseover mouseleave', evt => {
      let dd = this.loginDropdown;
      if (dd.length) {
        switch (evt.type) {
          case 'mouseover':
    ...
    this.loginLink.click(e => {
      e.stopPropagation();
    });
  }

  setDropdowns() {
    const args = Array.from(document.querySelectorAll('.header__sub-link'));
