...
/**
 * Represents a swiper component for customer relationship management interface.
...
class crmSwiper {
  constructor(settings, initialCard) {
    this.settings = {
      ...
      maxPrevCards: settings.maxPrevCards || 10,
      maxNextCards: settings.maxNextCards || 10,
      loadMoreAmount: settings.loadMoreAmount || 5
    }
...
for (const element of evtGoCrm) {
  element.onclick = () => {
    ...
    swiperInstance = new crmSwiper({}, card)
    swiperInstance.init()
  }
}